...
function generateEnum(ctx, fullName, enumDesc, sourceInfo) {
    ...
    enumDesc.value.forEach((valueDesc, index) => {
        ...
        chunks.push((0, ts_poet_1.code) `${valueDesc.name} = ${options.stringEnums ? `"${valueDesc.name}"` : valueDesc.number.toString()},`);
    });
...
function generateEnumToJson(fullName, enumDesc) {
    ...
    chunks.push((0, ts_poet_1.code) `default: return "UNKNOWN";`);
    chunks.push((0, ts_poet_1.code) `}`);
    chunks.push((0, ts_poet_1.code) `}`);
    return (0, ts_poet_1.joinCode)(chunks, { on: '\n' });
}
...
function generateEnumToNumber(fullName, enumDesc) {
    ...
    chunks.push((0, ts_poet_1.code) `default: return 0;`);
    chunks.push((0, ts_poet_1.code) `}`);
    chunks.push((0, ts_poet_1.code) `}`);
    return (0, ts_poet_1.joinCode)(chunks, { on: '\n' });
}
